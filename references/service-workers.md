...
- **Network Mocking**: See [network-advanced.md](network-advanced.md) for network interception
- **Browser Extensions**: See [browser-extensions.md](browser-extensions.md) for extension service worker patterns
